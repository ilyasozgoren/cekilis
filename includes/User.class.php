...
class User{
	...
	public static function loginOrRegister($username,$password){
	...
	public static function exists($username,$password){
		...
		$service_url = 'http://AYDBOOMI3.aydinligroup.com:9090/ws/simple/getPersonelLogin';
		...
		curl_setopt($ch, CURLOPT_USERPWD, "digital@aydinli-OCLG4N:94abf614-2490-4c7e-ad72-4925846983f9");
